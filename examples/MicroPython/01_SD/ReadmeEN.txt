...
3. Basic use:
    ...
    2): Copy the WAVESHARE_RP2350_TOUCH_AMOLED_1_8.uf2 file in the python directory to the recognized 
        removable disk
    ...
    5): Copy this file to python in the Thonny IDE into RP2350-Touch-AMOLED-1.8and open the boot.py file
