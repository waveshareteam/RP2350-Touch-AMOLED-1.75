...
# UARTx = 1
UARTx = 1
# define the rp2350 uart baudrate , the default baudrate is 9600 of L76B 
BAUDRATE = 115200
...
# set rp2350 UARTx baudrate , it should be same as L76B baudrate , otherwise GPS NMEA sentence parser doesnt work
